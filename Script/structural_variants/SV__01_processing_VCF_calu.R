## ***************************
##
## Script name: caks_cal01_processing_vcf_files_SV.R
...
# data -----
model = 'caks-cal01'
samples = c('caks-cal01-51-050-000_downsampledNormal.filtered', 'caks-cal01-51-050-010_downsampledNormal.filtered', 'caks-cal01-51-050-020_downsampledNormal.filtered')
control = 'mgpf-ib001-10-050-000.filtered'
is_mouse = FALSE
