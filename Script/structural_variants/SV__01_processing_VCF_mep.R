## ***************************
##
## Script name: caks_mep01_processing_vcf_files_SV.R
...
# data -----
model = 'caks-mep01'
samples = c('caks-mep01-53-050-000_downsampledBL6Nx129s1.filtered', 'caks-mep01-53-050-010_downsampledBL6Nx129s1.filtered','caks-mep01-53-050-020_downsampledBL6Nx129s1.filtered')
control = 'mef_BL6Nx129s1.filtered'
is_mouse = TRUE
